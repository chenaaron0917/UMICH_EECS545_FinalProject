...
% Get data from minist data packages
function [images, labels, dim] = mnist_parse(path_to_digits, path_to_labels)
...
images=reshape(images,numCols*numRows,totalImages);
